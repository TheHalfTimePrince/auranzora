    ...
    class Simulation {
      ...
      createAllFBO() {
        ...
        for (const key in this.fbos) {
          (this.fbos as Record<string, THREE.WebGLRenderTarget>)[key] = new THREE.WebGLRenderTarget(
            this.fboSize.x,
            this.fboSize.y,
            opts
          );
      ...
      resize() {
        this.calcSize();
        for (const key in this.fbos) {
          const fbo = (this.fbos as Record<string, THREE.WebGLRenderTarget | null>)[key];
